...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form style="padding: 0px 25px" method="POST" action="{{ route('mensaje-popup') }}">
                @csrf
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="tour" class="form-control">
                            ...
                            <option value="Huchuy Qosqo a Machu Picchu 2 días">Huchuy Qosqo a Machu Picchu 2 días
                            </option>
                            ...
                            <option value="Caminata de Salkantay a Machu Picchu 4 días">Caminata de Salkantay a Machu
                                Picchu 4 días</option>
                            <option value="Caminata de Salkantay a Machu Picchu 5 días">Caminata de Salkantay a Machu
                                Picchu 5 días</option>
                            ...
                            <option value="Maras, Moray & Salineras con cuatrimotos">Maras, Moray & Salineras con
                                cuatrimotos</option>
                            <option value="Tour a la laguna Humantay">Tour a la laguna Humantay</option>
                            <option value="Tour al Valle Sagrado de los Incas">Tour al Valle Sagrado de los Incas
                            </option>
                            ...
                            <option value="Valle Sagrado y Machu Picchu 2 días">Valle Sagrado y Machu Picchu 2 días
                            </option>
